...
namespace invoice.Migrations
{
    ...
    [Migration("20250908032952_store")]
    partial class store
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("invoice.Core.Entites.Language", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "ar",
                            CreatedAt = new DateTime(2025, 9, 8, 3, 29, 51, 214, DateTimeKind.Utc).AddTicks(357),
                            IsDeleted = false,
                            Name = "Arabic",
                            Target = "Page"
                        },
                        ...
                        {
                            Id = "en",
                            CreatedAt = new DateTime(2025, 9, 8, 3, 29, 51, 214, DateTimeKind.Utc).AddTicks(377),
                            IsDeleted = false,
                            Name = "English",
                            Target = "Page"
                        });
            ...
            modelBuilder.Entity("invoice.Core.Entites.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "ca",
                            CreatedAt = new DateTime(2025, 9, 8, 3, 29, 51, 214, DateTimeKind.Utc).AddTicks(833),
                            IsDeleted = false,
                            Name = "Cash"
                        },
                        new
                        {
                            Id = "bt",
                            CreatedAt = new DateTime(2025, 9, 8, 3, 29, 51, 214, DateTimeKind.Utc).AddTicks(870),
                            IsDeleted = false,
                            Name = "BankTransfer"
                        });
                });
            ...
            modelBuilder.Entity("invoice.Core.Entites.ContactInfo", b =>
                {
                    b.HasOne("invoice.Core.Entites.Store", "Store")
                        ...
                        .HasForeignKey("invoice.Core.Entites.ContactInfo", "StoreId")
            ...
            modelBuilder.Entity("invoice.Core.Entites.Store", b =>
                {
                    ...
                    b.HasOne("invoice.Core.Entites.ApplicationUser", "User")
                        .WithOne("Store")
                        .HasForeignKey("invoice.Core.Entites.Store", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
