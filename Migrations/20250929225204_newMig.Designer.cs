...
namespace invoice.Migrations
{
    ...
    [Migration("20250929225204_newMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("invoice.Core.Entities.Commission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("invoice.Core.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "ar",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(1551),
                            IsDeleted = false,
                            Name = "Arabic"
                        },
                        new
                        {
                            Id = "en",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(1608),
                            IsDeleted = false,
                            Name = "English"
                        });
                });
            ...
            modelBuilder.Entity("invoice.Core.Entities.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "ca",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2172),
                            IsDeleted = false,
                            Name = "Cash"
                        },
                        new
                        {
                            Id = "cc",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2382),
                            IsDeleted = false,
                            Name = "CreditCard"
                        },
                        new
                        {
                            Id = "dc",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2408),
                            IsDeleted = false,
                            Name = "DebitCard"
                        },
                        new
                        {
                            Id = "bt",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2442),
                            IsDeleted = false,
                            Name = "BankTransfer"
                        },
                        new
                        {
                            Id = "pp",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2459),
                            IsDeleted = false,
                            Name = "PayPal"
                        },
                        new
                        {
                            Id = "st",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2476),
                            IsDeleted = false,
                            Name = "Stripe"
                        },
                        new
                        {
                            Id = "ap",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2493),
                            IsDeleted = false,
                            Name = "ApplePay"
                        },
                        new
                        {
                            Id = "gp",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2510),
                            IsDeleted = false,
                            Name = "GooglePay"
                        },
                        new
                        {
                            Id = "ma",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2527),
                            IsDeleted = false,
                            Name = "Mada"
                        },
                        new
                        {
                            Id = "sp",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2543),
                            IsDeleted = false,
                            Name = "STCPay"
                        },
                        new
                        {
                            Id = "sa",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2560),
                            IsDeleted = false,
                            Name = "Sadad"
                        },
                        new
                        {
                            Id = "dl",
                            CreatedAt = new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2584),
                            IsDeleted = false,
                            Name = "Delivery"
                        });
                });
            ...
            modelBuilder.Entity("invoice.Core.Entities.Commission", b =>
                {
                    b.HasOne("invoice.Core.Entities.Invoice", "Invoice")
                        .WithOne("Commission")
                        .HasForeignKey("invoice.Core.Entities.Commission", "InvoiceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("invoice.Core.Entities.ApplicationUser", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("invoice.Core.Entities.PaymentLink", b =>
                {
                    ...
                    b.HasOne("invoice.Core.Entities.Invoice", "Invoice")
                        .WithOne("PaymentLink")
                        .HasForeignKey("invoice.Core.Entities.PaymentLink", "InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsOne("invoice.Core.Entities.utils.PurchaseCompletionOptions", "PurchaseOptions", b1 =>
                        {
            ...
            modelBuilder.Entity("invoice.Core.Entities.Store", b =>
                {
                    ...
                    b.OwnsOne("invoice.Core.Entities.utils.Shipping", "Shipping", b1 =>
                        {
                            b1.Property<string>("StoreId")
                                .HasColumnType("nvarchar(8)");
                    ...
                    b.OwnsOne("invoice.Core.Entities.utils.StoreSettings", "StoreSettings", b1 =>
                        {
                            b1.Property<string>("StoreId")
                                .HasColumnType("nvarchar(8)");
                            ...
                            b1.OwnsOne("invoice.Core.Entities.utils.PurchaseCompletionOptions", "purchaseOptions", b2 =>
                                {
