        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Settled = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commissions_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentLinks_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceId = table.Column<string>(type: "nvarchar(8)", nullable: false),
                    ProductId = table.Column<string>(type: "nvarchar(8)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ar", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(1551), null, "Arabic", null },
                    { "en", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(1608), null, "English", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ap", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2493), null, "ApplePay", null },
                    { "bt", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2442), null, "BankTransfer", null },
                    { "ca", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2172), null, "Cash", null },
                    { "cc", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2382), null, "CreditCard", null },
                    { "dc", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2408), null, "DebitCard", null },
                    { "dl", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2584), null, "Delivery", null },
                    { "gp", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2510), null, "GooglePay", null },
                    { "ma", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2527), null, "Mada", null },
                    { "pp", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2459), null, "PayPal", null },
                    { "sa", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2560), null, "Sadad", null },
                    { "sp", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2543), null, "STCPay", null },
                    { "st", new DateTime(2025, 9, 30, 1, 52, 2, 136, DateTimeKind.Unspecified).AddTicks(2476), null, "Stripe", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentLinks_ApplicationUserId",
                table: "PaymentLinks",
