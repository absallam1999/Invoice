...
namespace invoice.Core.Interfaces.Services
{
    public interface IPaymentLinkService
    {
        ...
        Task<GeneralResponse<PaymentLinkReadDTO>> CreateCustomPaymentLinkAsync(CustomPaymentLinkCreateDTO dto, string userId);
        ...
        Task<GeneralResponse<IEnumerable<PaymentLinkReadDTO>>> GetCustomPaymentLinksAsync(string userId);
        ...
        Task<GeneralResponse<PaymentLinkReadDTO>> RefreshGatewayLinkAsync(string paymentLinkId, string userId);
        Task<GeneralResponse<bool>> AttachPaymentAsync(string paymentLinkId, Payment payment, string userId);
        Task<GeneralResponse<decimal>> GetTotalRevenueFromCustomLinksAsync(string userId);
        Task<GeneralResponse<bool>> ValidatePaymentLinkAsync(string paymentLinkId, string userId);
        Task<GeneralResponse<bool>> DeactivateExpiredLinksAsync(string userId);
        Task<GeneralResponse<IEnumerable<PaymentLinkReadDTO>>> GetActiveLinksAsync(string userId);
        Task<GeneralResponse<IEnumerable<PaymentLinkReadDTO>>> GetExpiringSoonLinksAsync(int daysThreshold, string userId);
