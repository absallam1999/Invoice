...
namespace invoice.Services
{
    public class PageService : IPageService
    {
        ...
        public async Task<GeneralResponse<IEnumerable<PageReadDTO>>> GetAllAsync(string storeId = null, string languageId = null)
        {
        ...
        public async Task<GeneralResponse<PageReadDTO>> GetByTitleAsync(string title, string storeId = null, string languageId = null)
        {
            var pages = await _pageRepo.QueryAsync(
                p => p.Title == title &&
        ...
        public async Task<GeneralResponse<IEnumerable<PageReadDTO>>> SearchAsync(string keyword, string storeId = null, string languageId = null)
        {
            var pages = await _pageRepo.QueryAsync(
